...
.onWrite((event, context) => {
	...
	// console.log("event.after.val(): ", event.after.val());
	
	//get the message that was written
	//let message = event.after.val().child('message').val();
	//let messageUserId = event.after.val().child('user_id').val();
	let message = event.after.val().message;
	let messageUserId = event.after.val().user_id;

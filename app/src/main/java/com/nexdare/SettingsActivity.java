...
public class SettingsActivity extends AppCompatActivity implements ChangePhotoDialog.OnPhotoReceivedListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(com.nexdare.R.layout.activity_settings);
        Log.d(TAG, "onCreate: started.");
        mEmail = (EditText) findViewById(com.nexdare.R.id.input_email);
        mCurrentPassword = (EditText) findViewById(com.nexdare.R.id.input_password);
        mSave = (Button) findViewById(com.nexdare.R.id.btn_save);
        mProgressBar = (ProgressBar) findViewById(com.nexdare.R.id.progressBar);
        mResetPasswordLink = (TextView) findViewById(com.nexdare.R.id.change_password);
        mName = (EditText) findViewById(com.nexdare.R.id.input_name);
        mPhone = (EditText) findViewById(com.nexdare.R.id.input_phone);
        mProfileImage = (ImageView) findViewById(com.nexdare.R.id.profile_image);
        ...
        mSave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!mEmail.getText().toString().equals(FirebaseAuth.getInstance().getCurrentUser().getEmail())) {
                    ...
                    if (!isEmpty(mEmail.getText().toString()) && !isEmpty(mCurrentPassword.getText().toString())) {
                        ...
                        Toast.makeText(SettingsActivity.this,
                                "Email and Current Password Fields Must be Filled to Save", Toast.LENGTH_SHORT).show();
                    }
                }
                ...
                if (!mName.getText().toString().equals("")) {
                    reference.child(getString(com.nexdare.R.string.dbnode_users))
                            .child(FirebaseAuth.getInstance().getCurrentUser().getUid())
                            .child(getString(com.nexdare.R.string.field_name)).setValue(mName.getText().toString());
                }
                ...
                if (!mPhone.getText().toString().equals("")) {
                    reference.child(getString(com.nexdare.R.string.dbnode_users))
                            .child(FirebaseAuth.getInstance().getCurrentUser().getUid())
                            .child(getString(com.nexdare.R.string.field_phone)).setValue(mPhone.getText().toString());
                }
        ...
        mProfileImage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (mStoragePermissions) {
                    ...
                    dialog.show(getSupportFragmentManager(), getString(com.nexdare.R.string.dialog_change_photo));
                } else {
                    verifyStoragePermissions();
                }
    ...
    /**
     * Uploads a new profile photo to Firebase Storage using a @param
     * ***imageBitmap***
     * 
     * @param imageBitmap
     */
    ...
    private void getUserAccountData() {
         ...
         * ---------- QUERY Method 1 ----------
         */
        Query query1 = reference.child(getString(com.nexdare.R.string.dbnode_users)).orderByKey()
         ...
         * ---------- QUERY Method 2 ----------
         */
        Query query2 = reference.child(getString(com.nexdare.R.string.dbnode_users))
                .orderByChild(getString(com.nexdare.R.string.field_user_id))
                .equalTo(FirebaseAuth.getInstance().getCurrentUser().getUid());
    ...
    private void editUserEmail() {
        // Get auth credentials from the user for re-authentication. The example below
        // shows
        ...
        AuthCredential credential = EmailAuthProvider.getCredential(
                FirebaseAuth.getInstance().getCurrentUser().getEmail(), mCurrentPassword.getText().toString());
        Log.d(TAG,
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        if (task.isSuccessful()) {
                            ...
                            if (isValidDomain(mEmail.getText().toString())) {
                                ...
                                /////////////////// now check to see if the email is not already present in the
                                /////////////////// database
                                FirebaseAuth.getInstance().fetchProvidersForEmail(mEmail.getText().toString())
                                        .addOnCompleteListener(new OnCompleteListener<ProviderQueryResult>() {
                                            ...
                                            public void onComplete(@NonNull Task<ProviderQueryResult> task) {
                                                ...
                                                if (task.isSuccessful()) {
                                                    ///////// getProviders().size() will return size 1 if email ID is in
                                                    ///////// use.
            ...
            user.sendEmailVerification().addOnCompleteListener(new OnCompleteListener<Void>() {
                ...
                public void onComplete(@NonNull Task<Void> task) {
                    if (task.isSuccessful()) {
                        ...
                        Toast.makeText(SettingsActivity.this, "Couldn't Verification Send Email", Toast.LENGTH_SHORT)
                                .show();
                    }
                }
            });

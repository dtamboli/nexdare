            ...
            public void onClick(View v) {
                ...
                if(!mName.getText().toString().equals("")){
                    reference.child(getString(com.nexdare.R.string.dbnode_users))
                            ...
                            .child(getString(com.nexdare.R.string.field_name))
                ...
                if(!mPhone.getText().toString().equals("")){
                    reference.child(getString(com.nexdare.R.string.dbnode_users))
                            .child(FirebaseAuth.getInstance().getCurrentUser().getUid())
                            .child(getString(com.nexdare.R.string.field_phone))
...
//specify where the photo will be stored
            ...
            uploadTask.addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    ...
                    FirebaseDatabase.getInstance().getReference()
                            .child(getString(com.nexdare.R.string.dbnode_users))
                            .child(FirebaseAuth.getInstance().getCurrentUser().getUid())
    ...
    private void getUserAccountData(){
        ...
        /*
            ---------- QUERY Method 1 ----------
         */
        Query query1 = reference.child(getString(com.nexdare.R.string.dbnode_users))
                .orderByKey()

...
import com.nexdare.models.fcm.Data;
import com.nexdare.models.fcm.FirebaseCloudMessage;
import com.nexdare.utility.EmployeesAdapter;
import com.nexdare.utility.FCM;
import com.nexdare.utility.VerticalSpacingDecorator;
...
public class AdminActivity extends AppCompatActivity {
    ...
    private void init() {
        // Originally everything was a department but then tried to 
        // make everything a Team and now is late and should go to sleep 
        ...
        mDepartments.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                builder.setTitle("Click to Select Teams:");
                ...
                // get the teams (deparments) that are already added to the list
        ...
        mAddDepartment.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Log.d(TAG, "onClick: opening dialog to add new team");
        ...
        mSendMessage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!isEmpty(message) && !isEmpty(title)) {
                    ...
                    Toast.makeText(AdminActivity.this, "Fill out the title and message fields", Toast.LENGTH_SHORT)
                            .show();
                }
            }
        });
    ...
    private void sendMessageToDepartment(String title, String message) {
        Log.d(TAG, "sendMessageToDepartment: sending message to selected teams.");
    ...
    /**
     * Retrieves the server key for the Firebase server. This is required to send
     * FCM messages.
     */
    ...
    private void getDepartmentTokens() {
        ...
        for (String department : mSelectedDepartments) {
            ...
            Query query = reference.child(getString(R.string.dbnode_users))
                    .orderByChild(getString(R.string.field_department)).equalTo(department);
            ...
            query.addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(DataSnapshot dataSnapshot) {
                    for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                        ...
                        Log.d(TAG,
                                "onDataChange: got a token for user named: " + snapshot.getValue(User.class).getName());
                        mTokens.add(token);
                    }
                }
    ...
    public void setDepartmentDialog(final User user) {
        Log.d(TAG, "setDepartmentDialog: setting the team of: " + user.getName());

        AlertDialog.Builder builder = new AlertDialog.Builder(AdminActivity.this);
        builder.setIcon(R.drawable.ic_departments);
        builder.setTitle("Set a Team for " + user.getName() + ":");
        ...
        final ListAdapter adapter = new ArrayAdapter<String>(AdminActivity.this, android.R.layout.simple_list_item_1,
                mDepartmentsList);
        builder.setSingleChoiceItems(adapter, index, new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                Toast.makeText(AdminActivity.this, "Team Saved", Toast.LENGTH_SHORT).show();
                DatabaseReference reference = FirebaseDatabase.getInstance().getReference();
                reference.child(getString(R.string.dbnode_users)).child(user.getUser_id())
                        .child(getString(R.string.field_department)).setValue(mDepartmentsList.get(which));
                dialog.dismiss();

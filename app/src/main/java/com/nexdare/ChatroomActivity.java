...
import com.nexdare.utility.ChatMessageListAdapter;
...
public class ChatroomActivity extends AppCompatActivity {
            ...
            public void onClick(View view) {
                ...
                if (!mMessage.getText().toString().equals("")) {
                    ...
                    DatabaseReference reference = FirebaseDatabase.getInstance().getReference()
                            .child(getString(R.string.dbnode_chatrooms)).child(mChatroom.getChatroom_id())
    ...
    private void getChatroomMessages() {
        ...
        Query query = reference.child(getString(R.string.dbnode_chatrooms)).child(mChatroom.getChatroom_id())
                .child(getString(R.string.field_chatroom_messages));
        query.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                    ...
                    Log.d(TAG, "onDataChange: found chatroom message: " + snapshot.getValue());
    ...
    private void getUserDetails() {
        ...
        for (int i = 0; i < mMessagesList.size(); i++) {
            // Log.d(TAG, "onDataChange: searching for userId: " +
            // mMessagesList.get(i).getUser_id());
            final int j = i;
    ...
    private void initMessagesList() {
        mAdapter = new ChatMessageListAdapter(ChatroomActivity.this, R.layout.layout_chatmessage_listitem,
                mMessagesList);
    ...
    private void updateNumMessages(int numMessages) {
        ...
        reference.child(getString(R.string.dbnode_chatrooms)).child(mChatroom.getChatroom_id())
                .child(getString(R.string.field_users)).child(FirebaseAuth.getInstance().getCurrentUser().getUid())
                .child(getString(R.string.field_last_message_seen)).setValue(String.valueOf(numMessages));
    }
    ...
    private void enableChatroomListener() {
        ...
        mMessagesReference = FirebaseDatabase.getInstance().getReference().child(getString(R.string.dbnode_chatrooms))
                .child(mChatroom.getChatroom_id()).child(getString(R.string.field_chatroom_messages));

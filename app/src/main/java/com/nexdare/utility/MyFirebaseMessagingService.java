...
import com.nexdare.AdminActivity;
import com.nexdare.ChatActivity;
import com.nexdare.ChatroomActivity;
import com.nexdare.LoginActivity;
import com.nexdare.R;
import com.nexdare.RegisterActivity;
import com.nexdare.SettingsActivity;
import com.nexdare.SignedInActivity;
...
public class MyFirebaseMessagingService extends FirebaseMessagingService {
    ...
    public void onMessageReceived(RemoteMessage remoteMessage) {
        ...
        // SITUATION: Application is in foreground then only send priority notificaitons
        // such as an admin notification
                ...
                query.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        if (dataSnapshot.getChildren().iterator().hasNext()) {
                            ...
                            chatroom.setSecurity_level(
                                    objectMap.get(getString(R.string.field_security_level)).toString());

                            Log.d(TAG, "onDataChange: chatroom: " + chatroom);

                            int numMessagesSeen = Integer.parseInt(snapshot.child(getString(R.string.field_users))
                                    .child(FirebaseAuth.getInstance().getCurrentUser().getUid())
                                    .child(getString(R.string.field_last_message_seen)).getValue().toString());

                            int numMessages = (int) snapshot.child(getString(R.string.field_chatroom_messages))
                                    .getChildrenCount();
    ...
    private void sendChatmessageNotification(String title, String message, Chatroom chatroom) {
        ...
        PendingIntent notifyPendingIntent = PendingIntent.getActivity(this, 0, pendingIntent,
        ...
        builder.setSmallIcon(R.drawable.tabian_consulting_logo)
                ...
                .setAutoCancel(true).setSubText(message)
    ...
    private void sendBroadcastNotification(String title, String message) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            String id = getString(R.string.default_notification_channel_name);
            // The user-visible name of the channel.
            CharSequence name = getString(R.string.app_name);
            // The user-visible description of the channel.
            String description = getString(R.string.admin_broadcast);
    ...
    private boolean isApplicationInForeground() {
        ...
        boolean isActivityRunning = SignedInActivity.isActivityRunning || ChatActivity.isActivityRunning
                || AdminActivity.isActivityRunning || ChatroomActivity.isActivityRunning
                || LoginActivity.isActivityRunning || RegisterActivity.isActivityRunning
                || SettingsActivity.isActivityRunning;
